...
if locale == "zhCN" then
	SuperAPI_L = {
		...
		nameplate_motion_options = { "重叠", "默认分散", "智能分散" },
		healingtext_name = "浮动治疗文字",
		healingtext_desc = "切换世界场景中的治疗反馈文字。",
		nameplates_name = "姓名板设置",
		nameplates_desc = "与姓名板相关的设置。",
		nameplaterange_name = "姓名板显示距离",
		nameplaterange_desc = "调整姓名板出现的距离。",
		nameplatemotion_name = "姓名板移动方式",
		nameplatemotion_desc = "调整移动姓名板的排列方式。",
		chatbubbles_name = "聊天气泡设置",
		chatbubbles_desc = "与单位头顶聊天气泡相关的设置。",
		chatbubblerange_name = "聊天气泡显示距离",
		chatbubblerange_desc = "调整聊天气泡出现的距离。",
		saybubbles_name = "说话和喊话气泡",
		saybubbles_desc = "开启或关闭说话和喊话聊天气泡。",
		partybubbles_name = "小队聊天气泡",
		partybubbles_desc = "开启或关闭小队聊天气泡。",
		raidbubbles_name = "团队聊天气泡",
		raidbubbles_desc = "开启或关闭团队聊天气泡。",
		bgbubbles_name = "战场聊天气泡",
		bgbubbles_desc = "开启或关闭战场聊天气泡。",
		whisperbubbles_name = "密语聊天气泡",
		whisperbubbles_desc = "开启或关闭密语聊天气泡。",
		creaturebubbles_name = "生物聊天气泡",
		creaturebubbles_desc = "开启或关闭生物的聊天气泡。",
		support_name = "支持此项目",
		support_desc = "感谢你的捐赠！社区的支持让 SuperWoW 得以持续发展。",
	...
	SuperAPI_L = {
		...
		nameplate_motion_options = { "Overlap", "Default spread", "Smart spread" },
		healingtext_name = "Floating Healing Text",
		healingtext_desc = "Toggle display of in-world healing feedback.",
		nameplates_name = "Nameplate Settings",
		nameplates_desc = "Group of settings related to Nameplates",
		nameplaterange_name = "Nameplate range",
		nameplaterange_desc = "Changes the range at which Nameplates appear.",
		nameplatemotion_name = "Nameplate Motion",
		nameplatemotion_desc = "Changes the behavior of moving nameplates.",
		chatbubbles_name = "Chat Bubble Settings",
		chatbubbles_desc = "Group of settings related to Chat Bubbles that appear above units",
		chatbubblerange_name = "Chat Bubbles range",
		chatbubblerange_desc = "Changes the range at which Chat Bubbles appear.",
		saybubbles_name = "Say Chat Bubbles",
		saybubbles_desc = "Toggle say and yell chat bubbles on/off",
		partybubbles_name = "Party Chat Bubbles",
		partybubbles_desc = "Toggle party chat bubbles on/off",
		raidbubbles_name = "Raid Chat Bubbles",
		raidbubbles_desc = "Toggle raid chat bubbles on/off",
		bgbubbles_name = "Battleground Chat Bubbles",
		bgbubbles_desc = "Toggle battleground chat bubbles on/off",
		whisperbubbles_name = "Whisper Chat Bubbles",
		whisperbubbles_desc = "Toggle whisper chat bubbles on/off",
		creaturebubbles_name = "Creature Chat Bubbles",
		creaturebubbles_desc = "Toggle chat bubbles on creatures on/off",
		support_name = "Support The Project",
		support_desc = "All your donations are deeply appreciated! The community support is what keeps SuperWoW going",
